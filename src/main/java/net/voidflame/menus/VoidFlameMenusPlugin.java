...
public final class VoidFlameMenusPlugin extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        getLogger().info("VoidFlame-Menus enabled. Persistent data is provided by VoidFlame-Core.");
    }
    ...
    public CompletableFuture<Void> put(String key, String value) {
        try {
            return (CompletableFuture<Void>) put.invoke(storage, "menus", key, value);
        } catch (ReflectiveOperationException ex) {
    ...
    public CompletableFuture<String> get(String key) {
        try {
            return (CompletableFuture<String>) get.invoke(storage, "menus", key);
        } catch (ReflectiveOperationException ex) {
            return CompletableFuture.failedFuture(ex);
        }
    }
